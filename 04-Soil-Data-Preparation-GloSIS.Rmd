...
```{r element-tab, echo=FALSE, out.width="100%",fig.cap = "Horizon vs Layer en Element Features."}
...
```{r etl-landing, echo=FALSE, out.width="100%", fig.cap="GloSIS-ETL landing page."}
knitr::include_graphics("images/module4/glosis_etl.png")
```
...
```{r etl-standardization, echo=FALSE, out.width="100%", fig.cap="GloSIS Standardization service."}
