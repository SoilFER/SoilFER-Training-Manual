...
Environment variables (database credentials, logging level, etc.) are read from the `.env` file in the project root. The `.env` file stores configuration values that are shared between the services. The available variables are:
