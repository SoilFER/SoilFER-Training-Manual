...
2. Copy the files in the `GEE_export` folder into:
...
```{r plot-tab, echo=FALSE, out.width="100%",fig.cap = "Information in the Plot Data Sheet."}
knitr::include_graphics("images/module4/plot_tab.png")
```
...
```{r element-tab, echo=FALSE, out.width="100%",fig.cap = "Element Data Sheet in the XLSX template."}
knitr::include_graphics("images/module4/element_tab.png")
```
...
```{r specimen-tab, echo=FALSE, out.width="100%",fig.cap = "Specimen Data Sheet in the XLSX template."}
knitr::include_graphics("images/module4/specimen_tab.png")
```
...
```{r procedures-tab, echo=FALSE, out.width="100%",fig.cap = "Procedures Sheet in the XLSX template."}
knitr::include_graphics("images/module4/procedures_tab.png")
```
...
```{r metadata-tab, echo=FALSE, out.width="100%",fig.cap = "Procedures Sheet in the XLSX template."}
knitr::include_graphics("images/module4/metadata_tab.png")
```
...
```{r original-tab, echo=FALSE, out.width="100%",fig.cap = "Procedures Sheet in the XLSX template."}
knitr::include_graphics("images/module4/original_tab.png")
```
...
```{r glosis-etl, echo=FALSE, out.width="100%",fig.cap = "Application in the GloSIS-ETL."}
...
The GloSIS PostreSQL database is available for connection with external applications such as **pgAdmin**, **DBeaver**, **QGIS**, **R**, etc., using the parameters listed in Table \@ref(tab:db-connection).
...
```{r docker-compose-summary, echo=FALSE, warning = FALSE}
...
This will load the **landing page** with links to the three application modules.
...
```{r etl-harmonization, echo=FALSE, out.width="100%",fig.cap = "GloSIS-ETL Harmonization Tool."}
...
```{r etl-harmonization-steps, echo=FALSE, out.width="100%",fig.cap = "GloSIS-ETL Harmonization Tool."}
...
```{r etl-harmonization-step1, echo=FALSE, out.width="100%",fig.cap = "Step 1 Warning Message: Required Site Parameter Identification."}
...
```{r etl-harmonization-step2, echo=FALSE, out.width="100%",fig.cap = "Mapping analytical procedures and units of measurement"}
...
```{r etl-harmonization-step4, echo=FALSE, out.width="100%",fig.cap = "Validation of analytical values"}
...
```{r etl-harmonization-step3, echo=FALSE, out.width="100%",fig.cap = "Quality Checks Tab."}
...
```{r etl-viewer, echo=FALSE, out.width="100%",fig.cap = "Automated Units Conversion in the Information in the GloSIS ETL-Harmonization tool"}
