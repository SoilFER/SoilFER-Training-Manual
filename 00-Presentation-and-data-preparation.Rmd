...
This module focuses on the organisation, standardisation, sharing and dissemination of soil information through a Soil Information System (SIS). The module introduces relevant international standards for structuring soil data and metadata and shows how the information produced during previous SoilFER modules can be organised and disseminated through a national soil information infrastructure.

**Session 5.1 – Soil Data Standards, Metadata and OpenNSIS**  
The first session introduces the basic concepts of soil data organisation, standardisation and dissemination through a Soil Information System.
Particular attention is given to ISO 28258, the international standard for the digital exchange of soil-related data. The session will explain the main elements relevant to organising soil information, including concepts such as projects, sites, plots, soil profiles and profile elements, specimens, observations and analytical results. ISO 28258 provides a framework for exchanging soil data while maintaining links between observations, sampling locations and the corresponding soil features.
The session also introduces the principles of ISO 19115/19139 for describing geospatial datasets through standardized metadata, supporting the documentation, discovery and exchange of soil information.
Finally, it presents OpenNSIS (Open National Soil Information System), developed by FAO as an open implementation of a national soil information infrastructure. The demonstration shows how data generated throughout the previous SoilFER modules—including soil observations, laboratory data and digital soil mapping products—can be integrated, managed and disseminated through the system.

**Session 5.2 – Practical Use of OpenNSIS**
The second session is a hands-on practical session focused on the use of OpenNSIS. Participants work on dedicated servers prepared for the training and practice the main steps required to manage and disseminate soil information through the system.
Using datasets produced during the previous SoilFER modules, participants explore how standardized soil profile data and spatial products can be incorporated into the SIS and made available for consultation and dissemination.
The aim of the two sessions is to connect the complete SoilFER data workflow—from field observations and laboratory analyses to digital soil mapping products—with their final organisation and dissemination through a national soil information system.
