...
[Predictive Soil Mapping with R (Hengl & MacMillan, 2019)](https://soilmapper.org/ "Predictive Soil Mapping with R"): [@hengl2019] An introduction to statistical and machine-learning methods for producing soil property and soil class maps, with workflows and code examples in R.
...
**Docker Desktop** is the application you install on your computer to run Docker containers locally. It provides the Docker engine, a graphical interface to manage running containers and images, and it bundles **Docker Compose** as an integrated component, so no separate installation of Compose is required.
...
The GloSIS-ETL application used in Module 4 is a multi-container system managed by **Docker Compose**. Installing **Docker Desktop** is therefore the only prerequisite. It provides both the container runtime and the Compose tool needed to deploy GloSIS.
