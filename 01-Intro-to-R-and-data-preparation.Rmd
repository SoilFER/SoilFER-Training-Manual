...
# Read shapefile of Kansas Counties
...
# Quick visualization
# Plot points colored by pH, then overlay county borders
plot(soil_sf["pH"], pch = 16, cex = 0.6, key.pos = 1)  # key.pos controls legend position
plot(st_geometry(admin), add = TRUE, col = NA, border = "black", lwd = 0.7)
...
```{r vector-buffer, echo=TRUE, eval=TRUE}
...
Data in this folder includes:
 ...
 - [**Env_Cov_250m_KANSAS.tif**](https://drive.google.com/file/d/1wURPmPLi2LdYq6zBhZN1e91EiiZsk8oX/view?usp=drive_link) (203.2 mb): Multi-layer raster stack with climatic, remote sensing, topographic information at 250 meter resolution. Used for both Sampling Design and Digital Soil Mapping.
 - [**HighRes_Cov_100m_Kansas.tif**](https://drive.google.com/file/d/1xf89gn4pBKsb5ynVIfKZd4MbT3ZL1Nf2/view?usp=drive_link) (535.6 mb). 100 m resolution rasters with remote sensing derived information. Used in Sampling Design.
...
The file `Cropland_Mask_KANSAS.tif`be split into two adjacent tiff files (`Cropland_Mask_KANSAS-0000000000-0000000000.tif` and `Cropland_Mask_KANSAS-0000000000-0000023296.tif`) that must be merged using this R script, and already presented in section `Spatial Operations on Rasters` as an example to merge rasters.
...
r2 <- rast("CCropland_Mask_KANSAS-0000000000-0000023296.tif")
